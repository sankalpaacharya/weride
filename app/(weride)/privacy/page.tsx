    ...
    <main className="max-w-4xl mx-auto px-6 py-12 bg-white rounded-lg">
      ...
      <section className="text-gray-700 mb-8">
        ...
        <p className="mb-4">
          ...
          details when you register or use our service.
        </p>
        <p className="mb-4">
          <strong>1.2. Vehicle Data:</strong> We may collect data about the
          vehicles you rent or provide for rent, including but not limited to
          location, usage, and condition.
        </p>
      </section>
      ...
      <section className="text-gray-700 mb-8">
        ...
        <p className="mb-4">
          ...
          facilitating vehicle rentals and processing payments.
        </p>
        <p className="mb-4">
          <strong>2.2. Communication:</strong> We may use your contact
          information to send you service-related notifications and updates.
        </p>
        <p className="mb-4">
          <strong>2.3. Legal Compliance:</strong> We may disclose your
      ...
      <section className="text-gray-700 mb-8">
        ...
        <p className="mb-4">
          <strong>4.2. With Third Parties:</strong> We do not sell or share your
          personal information with third parties for marketing purposes without
          your consent.
        </p>
      </section>
      ...
      <section className="text-gray-700 mb-8">
        ...
        <p className="mb-4">
          <strong>5.2. Deletion:</strong> You may request the deletion of your
      ...
      <section className="text-gray-700 mb-8">
        ...
        <p className="mb-4">
          <strong> Prohibited Activities:</strong> Users may not engage in any
          illegal activities or misuse the vehicles rented through our service.
          This includes, but is not limited to, reckless driving, unauthorized
          alterations, or using the vehicle for purposes other than agreed upon.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          notified of any changes via email or through our platform. Continued
          use of the service after changes are made constitutes acceptance of
          the new terms.
        </p>
        <p className="text-lg font-semibold mb-4">
        ...
        <p className="mb-4">
          ...
          service for any violation of these terms or for any other reason at
          our discretion.
        </p>
      </section>
    </main>
