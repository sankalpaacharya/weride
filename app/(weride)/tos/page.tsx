        ...
        <main className="max-w-4xl mx-auto px-6 py-12 bg-white  rounded-lg">
            ...
            <section className="text-gray-700 mb-8">
                <p className="text-lg font-semibold mb-4 text-center">
                    <strong>These terms govern your use of the vehicle rental service provided by ‘WeRide’.</strong>
                </p>
                <p className="mb-4" >
            ...
            <section className="text-gray-700 mb-8">
                ...
                <p className="mb-4">
                    <strong> Rental Fees:</strong> You agree to pay the hourly rental fee as set by the vehicle owner. The rental fee must be paid in full before the rental period begins.
                </p>
                <p className="mb-4">
                    <strong> Petrol Refill Requirement:</strong> Riders must refill the vehicle to the petrol level specified by the owner (pre-decided) before returning the vehicle. Failure to do so will result in additional charges.
                </p>
            </section>
            ...
            <section className="text-gray-700 mb-8">
                ...
                <p className="mb-4">
                    <strong> Damage or Loss:</strong> Riders are responsible for any damage or loss that occurs during the rental period. In case of any damage, the rider agrees to compensate the vehicle owner for the cost of repairs or replacement.
                </p>
                <p className="mb-4">
                    <strong>Cleanliness:</strong> The vehicle must be returned in a clean condition. A cleaning fee of Rs 200 will be charged if the vehicle is returned excessively dirty.
                </p>
            </section>
            ...
            <section className="text-gray-700 mb-8">
                ...
                <ul className="list-disc list-inside mb-4">
                    ...
                    <li>Aggressive driving, such as tailgating, weaving in and out of traffic, or improper passing.</li>
                    <li>Operating the vehicle under the influence of alcohol, drugs, or any other substances that impair driving ability.</li>
