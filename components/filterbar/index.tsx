...
export default function index() {
  return (
    <div className="bg-pattern h-[20rem] w-full flex flex-col items-center justify-center">
      <div>
        ...
        <div className="flex flex-col items-center mt-10">
          <div className="relative">
            ...
            />
            <span className="absolute right-[5px] bg-main rounded-full p-3 cursor-pointer top-[7px]">
