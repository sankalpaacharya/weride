                ...
                <ScrollArea className="h-[500px] rounded-md  p-4">
                  ...
                  <ul className="space-y-2 mt-5 list-disc">
                    ...
                    <p>
                      ...
                      consequences, fines, penalties, or damages resulting from
                      reckless driving
                      <Link className="underline" href="/">
                        {" "}
                        (read more).
                      ...
                      <div className="gap-5 flex p-3 w-full rounded-lg bg-[#388bc1] text-white">
                        ...
                        <div>
                          ...
                          <p className="font-normal ">
                            Please ride Carefully, don&apos;t damage the
                            vehicle. Enjoy your ride. There is nothing to say so
                            fuck off
                          </p>
                        </div>
                      </div>
